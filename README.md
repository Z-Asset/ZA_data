# Z Research · Data Stage

数据处理：数据发现与质量评估。资产定价 + 机器学习/深度学习研究工作流的一部分。

## 安装

```bash
dsh plugin --profile <你的profile> add zresearch-data
```

或从 npm：

```bash
npm install zresearch-data
```
